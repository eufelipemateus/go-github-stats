...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Relevance = field.NewInt(tableName, "relevance")
	_user.Show = field.NewBool(tableName, "show")
	_user.Following = userManyToManyFollowing{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Following", "models.Collect"),
		User: struct {
			field.RelationField
			Following struct {
				field.RelationField
			...
			RelationField: field.NewRelation("Following.User", "models.User"),
			Following: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Following.User.Following", "models.Collect"),
			},
		},
		Followers: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Following.Followers", "models.User"),
		},
	}
...
func (u *user) updateTableName(table string) *user {
	...
	u.Relevance = field.NewInt(table, "relevance")
	u.Show = field.NewBool(table, "show")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["relevance"] = u.Relevance
	u.fieldMap["show"] = u.Show
...
func (a userManyToManyFollowing) Model(m *models.User) *userManyToManyFollowingTx {
...
func (a userManyToManyFollowingTx) Find() (result []*models.Collect, err error) {
	return result, a.tx.Find(&result)
}

func (a userManyToManyFollowingTx) Append(values ...*models.Collect) (err error) {
...
func (a userManyToManyFollowingTx) Replace(values ...*models.Collect) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userManyToManyFollowingTx) Delete(values ...*models.Collect) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
